...
class SupportChatController extends Controller
{
    ...
    public function handleChat(Request $request)
    {
        ...
        // Define NextLevel Configurator's system instruction
        $systemInstruction = "You are 'NextLevel Configurator', an expert PC builder, hardware advisor, and 24/7 technical support agent for 'Next Level PC', a premium storefront specializing in custom gamer PCs, high-end workstations, PC components, and gaming peripherals.\n\n"
            ...
            . "**Important boundaries:** This store specializes strictly in high-end PC hardware and gaming. If a customer asks about unrelated items (like appliances, clothes, console exclusives, or general smartphones not related to PC gaming), politely inform them that 'Next Level PC' focuses exclusively on the ultimate PC gaming and workstation experience.\n\n"
        ...
        try {
            ...
            return response()->json([
                'status' => 'error',
                'reply' => "Marhaban! I am currently experiencing a tiny technical breeze here in the medina. Please give me a brief moment, or let me know how I can help you once my traditional mint tea is served! (API offline or key missing)",
